    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">建立商品主檔</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class=" my-3 bg-white p-2">
    <div class="">
        ...
        true])
        !!} --}}
        <form class="w-3/5 mx-auto" method="POST" action="{{route('CreateProduct')}}" enctype="multipart/form-data">
            @csrf
            <div class="col-12  text-end">
                <button type="submit" class="btn btn-primary px-5">確認新增</button>
            </div>
            <label for="" class="d-block mt-4">商品名稱</label>
            <input type="text" name="productName" class="form-control my-2" value="{{old('productName')}}" required
            ...
            <textarea name="productIntro" id="productIntro" cols="30" rows="3"
                style="    width: 100%;border: 1px solid #d6d6d6;border-radius: 5px;"></textarea>
            {{-- <div class="row">
                <div class="col-4">
...
<div class="row">
    <div class="col-6">
        ...
        <input type="number" name="sort" class="form-control my-2" value="{{old('sort')}}" id="sort" placeholder="排序">
    </div>
    <div class="col-6">
...
<textarea id="composition" name="composition">{{old('composition')}}</textarea>
<label for="" class="d-block mt-4">訂購流程</label>
<textarea id="buyflow" name="buyflow">{{old('buyflow')}}</textarea>
