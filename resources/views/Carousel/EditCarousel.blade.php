    ...
    <div class="col-xl-10 mx-auto">
        <div class="card shadow-none">
            <div class="card-body p-5">
                ...
                <form class="row g-3" method="POST" action="{{route('UpdateCarousel')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                        <label for="title" class="form-label">標題</label>
                        <input type="text" value="{{$carousel->title}}" name="title" class="form-control" required
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="url" class="form-control" value="{{$carousel->url}}" required id="url"
                            placeholder="標題">
                    </div>

                    <div class="col-12">
                        <label for="sort" class="form-label">排序值(數字越大越前面)</label>
                        <input type="text" name="sort" class="form-control" value="{{$carousel->sort}}" id="url"
                            placeholder="標題">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="formFile" type="file" value="" id="formFile">
                    </div>
                    <div class="text-center">
                        <input type="text" name="filename" hidden value="{{$carousel->filename}}">
                        <img src="{{asset('storage/Carousel/' . $carousel->filename)}}" style="max-width: 500px"
                    ...
                    <div class="mb-3 d-flex align-items-center">
                        ...
                        <div class="form-check-danger form-check form-switch mx-2 mb-1">
                            <input class="form-check-input" type="checkbox" value="" name="enable" id="enable"
                                @if($carousel->enable) checked @endif >
                    ...
                    <div class="col-12 text-center">
                        <input type="text" hidden name="editId" value="{{$carousel->id}}">
